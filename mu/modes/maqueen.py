...
from mu.modes.examples import MAQUEEN_EXAMPLES
...
class MaQueen(MicroPythonMode):
    """
    Represents the functionality required by the micro:bit mode.
    """
    name = _('Maqueen')
    description = _("Maqueen is an easy-to-use programming educational robot")
    icon = 'maqueen'
