...
from mu.modes import (PythonMode, MicrobitMode, DebugMode,
                      PyGameZeroMode, ESPMode, MaQueen, MaQueenPlus, HuskyLens)
...
def setup_modes(editor, view):
    ...
    *PREMATURE OPTIMIZATION ALERT* This may become more complex in future so
    ...
    modes = {
        ...
        'maqueen': MaQueen(editor, view),
        'maqueenplus': MaQueenPlus(editor, view),
        'huskylens':HuskyLens(editor, view)
    }
