...
from mu.modes.api import MICROBIT_APIS, SHARED_APIS, HUSKYLENS_APIS
from mu.modes.examples import HUSKYLENS_EXAMPLES
...
class DeviceFlasher(QThread):
    ...
    def __init__(self, paths_to_microbits, python_script, path_to_runtime, model_serial_number):
        """
        ...
        self.model_serial_number = model_serial_number
    ...
    def run(self):
        ...
        try:
            uflash.flash(paths_to_microbits=self.paths_to_microbits,
                         ...
                         path_to_runtime=self.path_to_runtime, model_serial_number=self.model_serial_number)
...
class HuskyLens(MicroPythonMode):
    """
    Represents the functionality required by the micro:bit mode.
    """
    name = _('HuskyLens')
    description = _("AI Machine Vision Sensor")
    icon = 'huskylens'
    ...
    valid_serial_numbers = [9900, 9901, 9904]  # Serial numbers of supported boards.

    python_script = ''

    examples = HUSKYLENS_EXAMPLES
    ...
    def api(self):
        ...
        tips.
        """
        return SHARED_APIS + MICROBIT_APIS + HUSKYLENS_APIS
