...
HUSKYLENS_EXAMPLES = {
 "commandrequest.py" :{"description" :"Get raw data from HuskyLens " ,"code" :'''"""Get raw data from HuskyLens 
microbit V2 apply """
...
while True:
    ...
    if(data):
        ...
        print("ID:",ID) 
  '''},
"text_display.py" :{"description" :"Display text on HuskyLens screen " ,"code" :'''""" Display text on HuskyLens screen
microbit V2 apply """
from huskylens import *
import utime
#Display "DFRobot" at posotion X: 10Y: 10 on screen
huskylens.command_request_custom_text("DFRobot",10,10)
utime.sleep(100)
#Clear all texts on screen
huskylens.command_request_clear_text()
  '''},
"algorithm_storage_and_reading.py" :{"description" :"Algorithm storage and reading" ,"code" :'''""" Algorithm storage and reading
microbit V2 apply"""
from huskylens import *
import utime
#Storage algorithm model to SD card
huskylens.command_request_save_mode_to_SD_card(1)
utime.sleep(100)
#Getting algorithm model from SD card
huskylens.command_request_load_model_from_SD_card(1)
utime.sleep(100)
  '''},
"photos_and_screenshots.py" :{"description" :"Photos and screenshots" ,"code" :'''""" Photos and screenshots
microbit V2 apply """
from huskylens import *
import utime
#Photos
huskylens.command_request_photo()
utime.sleep(100)
#Screenshots
huskylens.command_request_screenshot()
utime.sleep(100)
  '''},
"modify_ID_name.py" :{"description" :"Modify ID name " ,"code" :'''""" Modify ID name
microbit V2 apply"""
from huskylens import *
import utime
huskylens.command_knock()
huskylens.command_algorthim("ALGORITHM_FACE_RECOGNITION")
#Automatically learn ID 
huskylens.command_request_learn_once(1)
utime.sleep(10)
#Modify ID name   
huskylens.command_request_customnames(1,"DFRobot")
utime.sleep(100)
#Forget current algorithm  
huskylens.command_request_forget()
  '''},
"microbit_v1.py" :{"description" :"How to use microbit v1 " ,"code" :'''"""The usage of micro:bit V1 is consistent with that of V2, so we won't repeat it here.
Note: micro:bit V1 has limited storage, so you have to save functions based on your needs. Do not save all the functions into it, otherwise, it will lead to memory overflow. 
"""
