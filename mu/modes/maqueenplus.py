...
from mu.modes.examples import MAQUEENPLUS_EXAMPLES
...
class MaQueenPlus(MicroPythonMode):
    """
    Represents the functionality required by the micro:bit mode.
    """
    name = _('Maqueen Plus')
    description = _("Maqueen Plus is an easy-to-use and powerful programming education robot")
    icon = 'maqueenplus'
